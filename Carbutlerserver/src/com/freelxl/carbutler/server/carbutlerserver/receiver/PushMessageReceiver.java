package com.freelxl.carbutler.server.carbutlerserver.receiver;
...
import com.freelxl.carbutler.server.carbutlerserver.util.PushUtils;
...
public class PushMessageReceiver extends FrontiaPushMessageReceiver {
	 ...
	 *            上下文
	 * @param errorCode
	 *            错误码。0表示某些tag已经设置成功；非0表示所有tag的设置均失败。 // * @param successTags
	 *            设置成功的tag
	 * @param failTags
	 *            设置失败的tag
	 * @param requestId
	 ...
	 *            上下文
	 * @param errorCode
	 *            错误码。0表示某些tag已经删除成功；非0表示所有tag均删除失败。 // * @param successTags
	 *            成功删除的tag
	 * @param failTags
	 *            删除失败的tag
	 * @param requestId
