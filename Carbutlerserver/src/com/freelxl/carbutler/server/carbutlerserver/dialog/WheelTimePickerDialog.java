...
public class WheelTimePickerDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View view = View.inflate(context, R.layout.dialog_wheel_time_picker,
				null);
		setContentView(view);
		...
		String[] days = new String[] { month1 + "." + day1,
				month2 + "." + day2, month3 + "." + day3 };
	...
	public void bt_positive(View view) {
		if (mOnTimeSetListener != null) {
			...
			mOnTimeSetListener.onTimeSet(year, month + 1, day,
					hourOfDayCurrentItem, minuteCurrentItem);
		}
		this.dismiss();
	}
